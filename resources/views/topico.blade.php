                        ...
                        <div class="col-md-8">
                            <div class="content-card">
                                <div class="card-header">
                                    <i class="bi bi-info-circle"></i> Um breve resumo sobre {{$dados_topico->name}}
                                </div>
                                <div class="card-body">
                                    {!! $texto !!}
                                    ...
                                    <div class="card mb-3" data-note-id="1">
                                        <div class="card-header bg-light d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="note-actions">
                                                ...
                                                <!-- Botão Excluir -->
                                                <a href="/delete_anotacao/{{$anotacao->id}}" class="btn btn-sm btn-outline-danger ms-2 btn-delete" title="Excluir">
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <form action="/add_anotacao" method="POST">
                                @csrf
                                <input type="hidden" name="id_topic" value="{{ $dados_topico->id }}">
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label for="noteTitle" class="form-label">Título</label>
                                        <input type="text" class="form-control" id="noteTitle" name="titulo" required>
                                    </div>
                                    <div class="mb-3">
                        ...
                        <div class="card-body">
                            <div class="partner-card">
                                ...
                                <div class="partner-actions">
                                    <a href="/excluir_parceiro/{{$dados_topico->id}}/{{$parceiro->id}}" class="btn btn-sm btn-outline-primary"><i class="bi bi-trash"></i> Expulsar</a>
                                </div>
                            </div>
                        </div>
                        @endforeach
                ...
                <form action="/relacione" method="post">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="partnerEmail" name="email" placeholder="email@exemplo.com">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
