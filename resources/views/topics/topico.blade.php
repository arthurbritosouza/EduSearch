...
@section('content')
    ...
    <div class="page-header">
        <div class="header-content">
            <div class="header-info">
                ...
                <p class="page-subtitle">{{$data_topic->materia}} • Criado
                    em {{ \Carbon\Carbon::parse($data_topic->created_at)->format('d/m/Y') }}</p>
            </div>
                ...
                <div class="action-buttons">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#"><i class="bi bi-download me-2"></i>Exportar PDF</a>
                            </li>
                            ...
                            <li><a class="dropdown-item text-danger" href="#" data-bs-toggle="modal"
                                   data-bs-target="#deleteModal"><i class="bi bi-trash me-2"></i>Excluir</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <form action="{{ route('topic.update', $data_topic->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="topicName" name="name"
                                   value="{{ $data_topic->name }}" required>
                        </div>
    ...
    <div class="tabs-container">
        <ul class="nav nav-tabs enhanced-tabs" id="contentTabs" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="anotacao-tab" data-bs-toggle="tab" data-bs-target="#anotacao" type="button"
                        role="tab">
                            ...
                            <div class="levels-widget">
                                ...
                                <div class="levels-accordion" id="levelsAccordion">
                                    ...
                                    <div class="level-section">
                                        <div class="level-header" data-bs-toggle="collapse"
                                             data-bs-target="#levelBeginner">
                                        ...
                                        <div id="levelBeginner" class="collapse show" data-bs-parent="#levelsAccordion">
                                            <div class="level-content">
                                                @foreach ($materials->where('level', 1) as $material)
                                                    <a href="{{ route('material.show', $material->id) }} class="
                                                       material-link">
                                    ...
                                    <div class="level-section">
                                        <div class="level-header" data-bs-toggle="collapse"
                                             data-bs-target="#levelIntermediate">
                    ...
                    <div class="toolbar-right">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="#"><i class="bi bi-download me-2"></i>Baixar PDF</a>
                                </li>
                                <li><a class="dropdown-item" href="#"><i class="bi bi-share me-2"></i>Compartilhar</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    @foreach ($arrayEx as $exercise)
                        ...
                        <span class="exercise-badge {{ $exercise['level'] }}">
                            ...
                            <div class="exercise-footer">
                                <button class="btn btn-primary open-exercise-modal"
                            ...
                            <form action="/add_anotacao" method="POST">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="noteContent" rows="5" style="height: 200px;"
                                                  name="annotation" required></textarea>
                                    </div>
                                </div>
                                <div class="modal-footer">
                        ...
                        <div class="note-card" data-note-id="{{ $anotacao->id }}">
                            <div class="note-header">
                                ...
                                <div class="note-actions">
                                    <button class="btn btn-sm btn-outline-secondary btn-view" data-bs-toggle="modal"
                                    ...
                                    <a href="/excluir_anotacao/{{ $anotacao->id }}"
                    ...
                    @foreach($parceiros as $parceiro)
                        <div class="partner-card">
                            ...
                            <div class="partner-actions">
                                <a href="/excluir_parceiro/{{$data_topic->id}}/{{$parceiro->id}}"
                                   class="btn btn-sm btn-outline-danger">
    ...
    <div class="modal fade" id="addParceiroModall" tabindex="-1" aria-labelledby="addParceiroModallLabel"
         aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
