            ...
            <div class="search-container">
                ...
                <div class="row g-3">
                    <form action="/new_topic_folder" method="POST">
                        @csrf
                        <div class="col-md-10">
                            <input type="text" class="form-control search-input" name="topico" placeholder="Digite uma matéria ou tópico (ex: Biologia, Equações de 2º grau, Literatura Brasileira...)">
                        </div>
                        <div class="col-md-2">
